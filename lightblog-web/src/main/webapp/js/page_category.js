	...
	$.ajax({
            ...
            success: function(data){
                ...
                $.each(data.categoryMap.categoryList,function(i,categoryListItemMap){
					...
					str = '<span class="categpry_item"  style="font-size: '+font_size+'px"><a href="javascript:list_work_by_category('+categoryListItemMap.categoryName+',container_category);">'+categoryListItemMap.categoryName+'</a></span>';
